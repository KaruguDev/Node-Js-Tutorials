...
const geocodeAddress = (location, callback) => {
  URIencodedLocation = encodeURIComponent(location)
  const url = `https://api.tomtom.com/search/2/search/${URIencodedLocation}.json?key=HUxWDYGx3bjNLzsYg6SYMF6z8KX4NLsA&countrySet=KE`
